      ...
      >
        <div className="max-w-2xl">
          ...
          >
            ...
            >
              Få en offert
              <svg aria-hidden="true" focusable="false" className="w-4 h-4 transition-transform group-hover:translate-x-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
